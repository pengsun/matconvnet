...
if opts.enableImreadJpeg
  mex_src{end+1} = fullfile('matlab','src','vl_imreadjpeg.c') ;
end
...
% old matlab dosen't support '-cxx' option for mex
if (~verLessThan('matlab','7.12.1')),  flags.mexcc{end+1} = '-cxx' ; end
